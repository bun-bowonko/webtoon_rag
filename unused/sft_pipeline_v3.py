...
def train(project_id: str = "prod-ai-project",
        ...
        base_model_name_or_path: str = "gs://kakao-entertainment-cel-applied-ai-prod/bun/llama4/llama4_400b/f0ee6477b90b7a6aaefd2cfdf1b4a05d36184137",
        ...
        run_name: str = "sft_webtoon_250421_llama4_400b",
        report_to: str = "wandb",
        gcs_sft_output_dir: str = "gs://kakao-entertainment-cel-applied-ai-prod/bun/llama4/llama4_400b/sft-webtoon-250421",):
    ...
    tokenizer = AutoTokenizer.from_pretrained("meta-llama/Llama-4-Maverick-17B-128E-Instruct", trust_remote_code=True)
    tokenizer.pad_token = tokenizer.eos_token #빼야됨, llama4는 pad토큰 가지고 있음 -> 그래도 상관없음(내부로직에 따라)
    tokenizer.padding_side = "right"  # Fix weird overflow issue with fp16 training 

    # # ==== GPU 메모리 한도 설정 ====
    # max_memory = {f"cuda:{i}": "78GiB" for i in range(8)}
